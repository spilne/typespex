...
import { TypePlanner, type CodegenIssue } from "../src/unstable.js";

test("normalizes scalar-constructor defaults across the supported TypeSpec 1.x range", async () => {
  ...
  if (!first || !second || !third) throw new Error("Expected compatibility fixture models.");
