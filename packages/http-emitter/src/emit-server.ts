...
import { collectReferencedModelImports, type ServerEmission } from "./server-emission.js";
import { tsIdentifier, tsPropertyDeclaration } from "./typescript-names.js";

export function emitServer(ctx: EmitterCtx, emission: ServerEmission): string {
  const lines: string[] = [];
