...
export function emitServerRouter(ctx: EmitterCtx, httpOperations: HttpOperation[]): string {
  ...
  lines.push("");
  lines.push(
    'import type { ComposableHttpRouter, HttpInterpreterOptions, MatchedRequestContext } from "@typespex/http-server";',
  );
