...
const emitterSourceDir = resolve(repoRoot, "packages/http-emitter/src");
const emitterBuildArtifact = resolve(repoRoot, "packages/http-emitter/dist/index.js");
const emitterBuildStamp = resolve(repoRoot, "packages/http-emitter/dist/.test-build-complete");
const emitterBuildLock = resolve(repoRoot, ".context/test-build-locks/emitter");
const runtimeSourceDir = resolve(repoRoot, "packages/http-server/src");
const runtimeBuildArtifact = resolve(repoRoot, "packages/http-server/dist/server.d.ts");
const runtimeBuildStamp = resolve(repoRoot, "packages/http-server/dist/.test-build-complete");
...
const runtimeBuildInputs = [
  runtimeSourceDir,
  resolve(repoRoot, "packages/http-server/package.json"),
  resolve(repoRoot, "packages/http-server/tsconfig.json"),
  ...sharedBuildInputs,
];
const runtimeDeclarationPaths = [
  resolve(repoRoot, "packages/http-server/dist/index.d.ts"),
  resolve(repoRoot, "packages/http-server/dist/server.d.ts"),
];
