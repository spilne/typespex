...
The harness uses **Bun 1.4.2** and **oha 1.16.0**, a native HTTP load generator.
...
Bun static-response control with the same request and response payload, bypassing
